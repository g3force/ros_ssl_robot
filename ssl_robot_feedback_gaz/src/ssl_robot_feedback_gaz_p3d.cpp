...
void callbackModelStates(const nav_msgs::Odometry::ConstPtr& odo) {
...
int main(int argc, char **argv) {
	...
	std::cout << "Filter enabled: " << enableFilter << std::endl;
	...
	ros::Subscriber sub_model_states = n.subscribe("/ssl_robot/odom", 1,
			callbackModelStates);
